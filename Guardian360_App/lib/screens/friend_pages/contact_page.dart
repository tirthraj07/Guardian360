...
class AddCloseFriendsPage extends StatefulWidget {
  const AddCloseFriendsPage({Key? key}) : super(key: key);

  @override
  _AddCloseFriendsPageState createState() => _AddCloseFriendsPageState();
}

class _AddCloseFriendsPageState extends State<AddCloseFriendsPage> {
  ...
  Future<void> sendRequest() async {
    final url = Uri.parse(TravelAlertService.requestFriend);
    ...
    if (response.statusCode == 200) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text("Requested Succesfully"),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage(ContactsPageAssets.safeCircleImage))),
              ),
              if (_isLoading)
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  // Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>AadhaarCardPage(userID: int.parse(userData['userID']))));

                  Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>MainPage(userID: int.parse(userData['userID']) ?? 90)));
